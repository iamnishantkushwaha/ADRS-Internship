...
const StartYourJourney = () => {
  return (
   <div className=" h-screen  p-auto flex flex-col items-center  w-full">
      ...
      <button className="flex   rounded-xl px-7  text-white font-bold items-center justify-center py-2 bg-purple-500 hover:bg-purple-600 ">Contact Us Today<img src="./public/icons8-arrow-50.png" alt=""  /></button>
    </div>
  )
}
