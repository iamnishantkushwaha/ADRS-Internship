...
const AdditionalServices = () => {
  return (
    <div className="flex flex-col h-auto justify-center min-w-screen mb-20 items-center bg-primaryBackdround">
        ...
        <div className="h-fit w-fit flex flex-col mt-20  items-center justify-content ">
          <div className="w-full h-fit flex items-center justify-center">
            <span className="flex flex-col lg:flex-row gap-3">
              ...
              <h1 className="text-purple-400 font-bold text-3xl leading-3 lg:leading-none">Services</h1>
            </span>
          </div>
      ...
      <div className=" mt-10 grid  w-full justify-center items-center md:grid-cols-2 grid-col-1 grid-rows-4 md:grid-rows-2 md:px-11 lg:px-45 gap-8 ">
        <div className="h-110 w-full  md:p-10 p-5  bg-white/20  flex flex-col justify-center gap-5  rounded-xl hover:scale-105 hover:bg-blend-color-burn transition-all duration-1000 delay-150">
          <div>
        ...
        <div className="h-110 w-full lg:p-10 p-5  bg-white/20  flex flex-col justify-center gap-5  rounded-xl hover:scale-105 hover:bg-blend-color-burn transition-all duration-1000 delay-150">
          <div>
            <div className="bg-blue-600 rounded-xl h-15 w-15 flex items-center justify-center">
              <svg
                stroke="white"
        ...
        <div className="h-110 w-full  justify-center lg:p-10 p-5  bg-white/20  flex flex-col  gap-5  rounded-xl hover:scale-105 hover:bg-blend-color-burn transition-all duration-1000 delay-150">
          <div>
